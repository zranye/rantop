...
public class LabelValue implements Comparable, Serializable {
    ...
    public static final Comparator CASE_INSENSITIVE_ORDER = new Comparator() {
        public int compare(Object o1, Object o2) {
            String label1 = ((LabelValue) o1).getValue();
            String label2 = ((LabelValue) o2).getValue();
    ...
    public int compareTo(Object o) {
        ...
        String otherLabel = ((LabelValue) o).getValue();

        return this.getValue().compareTo(otherLabel);
    }
